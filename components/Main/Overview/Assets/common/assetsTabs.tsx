...
const assetsTabs = [{ title: "Overview", id: 1 }, { title: "Stocks", id: 2 }]
...
export const AssetsTabs = () => {
    ...
    <Box flexDirection="column">
        <Text fontFamily="Poppins" fontWeight={"400"} fontSize={16} lineHeight={28}>Hi Krish Parekh,</Text>
        <Text fontFamily="Poppins" fontWeight={"400"} fontSize={16} lineHeight={28}>Now all your Assets are in one single place</Text>
